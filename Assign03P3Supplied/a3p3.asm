...
#                   char byeStr[]    = "bye...";
					...
					sw $fp, 336($sp)
					addiu $fp, $sp, 340
					# I don't know what 5th thing is
...
#                         mean = PopulateArray1223(a1, a2, a3, used1, &used2, &used3);
					...
					move $s0, $v0		# set value to value returned					
...
#                   CoutCstrNL(dlStr);
					...
					# I dont know what the last thing is
...
###############################################################################
					...
					####################(4)####################
					sw $a0, 40($sp)		# save $a0 (= mean)
					sw $a1, 44($sp)		# save $a1 (= a1)
					sw $a2, 48($sp)		# save $a2 (= a2)
					sw $a3, 52($sp)							
